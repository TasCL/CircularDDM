...
dinvGauss <- function(x, mu, lambda) {
    .Call('CircularDDM_dinvGauss', PACKAGE = 'CircularDDM', x, mu, lambda)
}
...
dddm <- function(x, pVec, k = 141L) {
    .Call('CircularDDM_dddm', PACKAGE = 'CircularDDM', x, pVec, k)
}

#' @rdname dddm
#' @export
rddm <- function(n, pVec, p = .15) {
    .Call('CircularDDM_rddm', PACKAGE = 'CircularDDM', n, pVec, p)
}
